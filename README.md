...
## Current state — prototype v0.5.2 (2026-09-04)
...
- v0.5.2 freezes the lane once a flick starts, so an arcing thumb cannot change lanes mid-shot.
  One constant reverts it (`TUNE.LANE_LOCK_ON_FLICK`).
